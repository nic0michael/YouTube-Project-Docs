---
title: "Deploy MySQL in K3S Cluster Using Terraform Helm Provider and Bitnami Helm Chart"
date: 2023-09-08T12:45:30Z
draft: false
---
...
We can get the BitBami helm Charts here: \
https://artifacthub.io/ \
Search for bitnami and locate the MySQL Helm Chart \
...
Put this in the file:
```
resource "helm_release" "mysql_helm" {
  name       = "mysql"
  namespace  = kubernetes_namespace.mysql_ns
